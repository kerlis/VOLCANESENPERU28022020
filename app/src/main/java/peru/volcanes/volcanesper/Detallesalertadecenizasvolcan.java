    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        blocke92.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View arg0) {
                Intent intent = new Intent(Detallesalertadecenizasvolcan.this,Contactar.class);
        ...
        blocke12.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View arg0) {
                Intent intent = new Intent(Detallesalertadecenizasvolcan.this,Ultimasnotificaciones.class);
                startActivity(intent);
            }
        });
        ...
        blocke4a.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View arg0) {
                Intent intent = new Intent(Detallesalertadecenizasvolcan.this, Notificacionesconfig.class);
                startActivity(intent);
            }
        });
        ...
        horalocal.setText("Hora local: " + hora_d + " / Hora UTC: " + horautc_d);
