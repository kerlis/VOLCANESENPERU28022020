...
*/
     /*--------VISUALIZACION DE MENU----------*/
        ...
        blocke92.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View arg0) {
                Intent intent = new Intent(Volcancamara.this,Contactar.class);
        ...
        blocke12.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View arg0) {
                Intent intent = new Intent(Volcancamara.this,Ultimasnotificaciones.class);
                startActivity(intent);
            }
        });
        ...
        blocke4a.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View arg0) {
                Intent intent = new Intent(Volcancamara.this,Notificacionesconfig.class);
                startActivity(intent);
            }
        });
