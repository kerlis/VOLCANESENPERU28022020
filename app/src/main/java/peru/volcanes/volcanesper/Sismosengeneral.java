    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        blocke92.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View arg0) {
                Intent intent = new Intent(Sismosengeneral.this,Contactar.class);
        ...
        blocke12.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View arg0) {
                Intent intent = new Intent(Sismosengeneral.this,Ultimasnotificaciones.class);
                startActivity(intent);
            }
        });
        ...
        blocke4a.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View arg0) {
                Intent intent = new Intent(Sismosengeneral.this,Notificacionesconfig.class);
                startActivity(intent);
            }
        });
