    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        blocke92.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View arg0) {
                Intent intent = new Intent(Pdfvieweralertas.this,Contactar.class);
        ...
        blocke12.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View arg0) {
                Intent intent = new Intent(Pdfvieweralertas.this,Ultimasnotificaciones.class);
                startActivity(intent);
            }
        });
        ...
        blocke4a.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View arg0) {
                Intent intent = new Intent(Pdfvieweralertas.this,Notificacionesconfig.class);
                startActivity(intent);
            }
        });
