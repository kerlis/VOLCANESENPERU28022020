    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        blocke92.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View arg0) {
                Intent intent = new Intent(Reportesalertascenizastwo.this,Contactar.class);
        ...
        blocke12.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View arg0) {
                Intent intent = new Intent(Reportesalertascenizastwo.this,Ultimasnotificaciones.class);
                startActivity(intent);
            }
        });
        ...
        blocke4a.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View arg0) {
                Intent intent = new Intent(Reportesalertascenizastwo.this,Notificacionesconfig.class);
                startActivity(intent);
            }
        });
       ...
       //  mFirebaseDatabase4.orderByChild("orden").addChildEventListener(new ChildEventListener() {
        ...
        mFirebaseDatabase4.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                ...
                int iSwapCount = objetoalertacenizastwo.size() - 1;
                int iPosition = objetoalertacenizastwo.size()- 1;
                for (int j = 0; j < iSwapCount; j++)
                {
                    Collections.swap(objetoalertacenizastwo, iPosition, iPosition - 1);
