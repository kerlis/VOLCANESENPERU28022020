...
public class alertadecenizasextraordinario {
    String horasreporte;
    Integer orden;
    String enlaceurl;
    ...
    public alertadecenizasextraordinario(String enlaceurl, Integer orden, String horasreporte) {
        this.enlaceurl = enlaceurl;
        this.orden = orden;
        this.horasreporte = horasreporte;
    }
    public alertadecenizasextraordinario() {
    }
}